...
public:
  ...
  static Rcpp::NumericMatrix create_q_matrix(const std::vector<Prediction>& predictions);
  static Rcpp::NumericMatrix create_q2_matrix(const std::vector<Prediction>& predictions);
  static Rcpp::NumericMatrix create_q3_matrix(const std::vector<Prediction>& predictions);
  static Rcpp::NumericMatrix create_q4_matrix(const std::vector<Prediction>& predictions);
  static Rcpp::NumericMatrix create_yc_matrix(const std::vector<Prediction>& predictions);
