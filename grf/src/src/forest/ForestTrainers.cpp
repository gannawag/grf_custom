...
ForestTrainer ForestTrainers::instrumental_trainer(size_t outcome_index,
  ...
  std::unordered_map<size_t, size_t> observables = {
      ...
      {Observations::Q, instrument_index+1},
      {Observations::WORIG, instrument_index+2},
      {Observations::YORIG, instrument_index+3},
      {Observations::Q2, instrument_index+4},
      {Observations::Q3, instrument_index+5},
      {Observations::Q4, instrument_index+6}};
