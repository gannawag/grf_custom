...
const std::size_t Observations::Q = 3;
const std::size_t Observations::WORIG = 4;
const std::size_t Observations::YORIG = 5;
const std::size_t Observations::Q2 = 6;
const std::size_t Observations::Q3 = 7;
const std::size_t Observations::Q4 = 8;
