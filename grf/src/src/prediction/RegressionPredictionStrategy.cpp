...
const size_t RegressionPredictionStrategy::Q = 1;
...
std::vector<double> RegressionPredictionStrategy::q_effect(const PredictionValues& leaf_values) {
  std::vector<double> q;
  q.push_back(1);
  // return {average.at(OUTCOME) };
  return{q};
}
std::vector<double> RegressionPredictionStrategy::q2_effect(const PredictionValues& leaf_values) {
  std::vector<double> q;
  q.push_back(1);
  // return {average.at(OUTCOME) };
  return{q};
}
std::vector<double> RegressionPredictionStrategy::q3_effect(const PredictionValues& leaf_values) {
  std::vector<double> q;
  q.push_back(1);
  // return {average.at(OUTCOME) };
  return{q};
}
std::vector<double> RegressionPredictionStrategy::q4_effect(const PredictionValues& leaf_values) {
  std::vector<double> q;
  q.push_back(1);
  // return {average.at(OUTCOME) };
  return{q};
...
std::vector<double> RegressionPredictionStrategy::yc_effect(const PredictionValues& leaf_values) {
  std::vector<double> q;
  q.push_back(1);
  // return {average.at(OUTCOME) };
  return{q};
