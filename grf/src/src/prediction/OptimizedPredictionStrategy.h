...
public:
  ...
  */
  virtual std::vector<double> predict(const std::vector<double>& average_prediction_values) = 0;
    ...
    virtual std::vector<double> q_effect(const PredictionValues& leaf_values) = 0;
     virtual std::vector<double> yc_effect(const PredictionValues& leaf_values) = 0;
     virtual std::vector<double> q2_effect(const PredictionValues& leaf_values) = 0;
     virtual std::vector<double> q3_effect(const PredictionValues& leaf_values) = 0;
     virtual std::vector<double> q4_effect(const PredictionValues& leaf_values) = 0;
