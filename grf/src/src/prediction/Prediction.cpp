...
const std::vector<double>& Prediction::get_qs() const {
  return q;
}


const std::vector<double>& Prediction::get_q2s() const {
  return q2;
}
const std::vector<double>& Prediction::get_q3s() const {
  return q3;
}
const std::vector<double>& Prediction::get_q4s() const {
  return q4;
}

const std::vector<double>& Prediction::get_ycs() const {
  return yc;
}
