...
public:
  ...
  const std::vector<double>& get_qs() const;
  const std::vector<double>& get_q2s() const;
  const std::vector<double>& get_q3s() const;
  const std::vector<double>& get_q4s() const;
  const std::vector<double>& get_ycs() const;
